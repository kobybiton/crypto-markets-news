...
@section('content')
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <form class="form" name="form" action="{{ route('cms/store-tag') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                  <button class="btn btn-success upload" type="submit">Update Tag</button>
                </div>
                <div class="alert success alert-primary">Tag is updated!</div>
